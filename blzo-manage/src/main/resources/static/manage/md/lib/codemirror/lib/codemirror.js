...
(function(mod) {
  ...
  function Display(place, doc, input) {
    ...
    // Wraps everything that needs to exist inside the vertically-padded coordinate mine
  ...
  // coordinates into another coordinate mine. Context may be one of
  ...
  // Coverts a box from "div" coords to another coordinate mine.
  // Context may be "window", "page", "div", or "local"/null.
  function fromCoordSystem(cm, coords, context) {
    if (context == "div") return coords;
    var left = coords.left, top = coords.top;
    // First move into "page" coordinate mine
    if (context == "page") {
      left -= pageScrollX();
      top -= pageScrollY();
  ...
  // Input must be lineSpace-local ("div" coordinate mine).
