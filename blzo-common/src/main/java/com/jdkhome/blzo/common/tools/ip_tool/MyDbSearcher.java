package com.jdkhome.blzo.common.tools.ip_tool;
...
/**
 * author link.ji
 * createTime 下午2:53 2018/8/3
 *
 * org.lionsoul.ip2region 提供的DbSearcher 不支持resources读取db文件
 * 所以这里重写了一个MyDbSearcher
 */
public class MyDbSearcher {
     ...
     */
    public MyDbSearcher(DbConfig dbConfig, File dbFile) throws FileNotFoundException {
